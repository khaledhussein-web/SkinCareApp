...
export const AdminUsersScreen = () => {
  ...
  const handleBanUser = async (user) => {
    ...
    try {
      await setAdminUserBan(user.id, nextBanned);
      setUsers((prev) =>
        prev.map((item) =>
          item.id === user.id ? { ...item, status: nextBanned ? "banned" : "active" } : item,
        ),
      );
              ...
              <table className="w-full">
                <thead className="bg-slate-50 border-b">
                  <tr>
                    ...
                    <th className="text-left p-4 text-sm text-slate-600">Last Update</th>
                    ...
                    >
                      ...
                      <td className="p-4">
                        <div className="flex items-center justify-end gap-2">
                          ...
                          <Button variant="ghost" size="sm" onClick={() => handleBanUser(user)}>
                            {user.status === "banned" ? (
