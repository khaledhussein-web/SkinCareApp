    ...
    <div className="min-h-screen bg-gradient-to-br from-pink-50 via-purple-50 to-blue-50">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <div className="relative">
                <div className="absolute inset-0 bg-gradient-to-r from-pink-400 to-purple-500 rounded-3xl blur-3xl opacity-30 animate-pulse" />
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div className="p-4 bg-gradient-to-br from-green-50 to-emerald-50 rounded-xl">
                        ...
                        <div className="text-sm text-slate-600">Normal Skin</div>
                      </div>
                      <div className="p-4 bg-gradient-to-br from-blue-50 to-cyan-50 rounded-xl">
                        <div className="text-2xl mb-1">💧</div>
                        <div className="text-sm text-slate-600">Well Hydrated</div>
                      </div>
                    </div>
                  </div>
                </div>
      ...
      <footer className="py-8 px-4 bg-white/50 border-t">
        <div className="max-w-7xl mx-auto text-center text-slate-600">
          <p className="text-sm">
            © 2026 SkinCare AI. For educational purposes only. Consult a dermatologist for medical advice.
          </p>
        </div>
      </footer>
    </div>
