...
import { fetchWeatherData, WeatherData, getEnvironmentalRecommendations } from '@/app/services/weatherService';
        ...
        <CardContent className="p-6">
          ...
          <div className="mt-4 p-3 bg-blue-100 rounded-lg">
            <p className="text-xs text-blue-900">
              💡 <strong>Tip:</strong> Weather conditions updated in real-time to provide the most
              relevant skincare advice for your environment.
            </p>
          </div>
        </CardContent>
      </Card>
